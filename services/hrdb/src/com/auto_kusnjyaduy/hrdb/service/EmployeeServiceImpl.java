...
package com.auto_kusnjyaduy.hrdb.service;
...
import com.auto_kusnjyaduy.hrdb.Employee;
import com.auto_kusnjyaduy.hrdb.Vacation;
...
public class EmployeeServiceImpl implements EmployeeService {
	...
	public Employee update(Employee employee) {
        ...
        if(employeesForManagerId != null && Hibernate.isInitialized(employeesForManagerId) && !employeesForManagerId.isEmpty()) {
            ...
            _remainingChildren.forEach(_employee -> delete(_employee));
        ...
        if(vacations != null && Hibernate.isInitialized(vacations) && !vacations.isEmpty()) {
            ...
            LOGGER.debug("Found {} detached children, deleting", _remainingChildren.size());
            _remainingChildren.forEach(_vacation -> vacationService.delete(_vacation));
